...
# epic-00004 Telegram Topics Delivery — 計画（Issues / Order）
...
## Issue 一覧（順序付き） (必須)
- iss-00010-telegram-topic-mapping-and-send (MVP: topic 作成 + 最終アウトプット送信):
  - 目的:
  ...
  - Depends on:
    - epic-00003（Local Logging and Summary）の log 保存（最後のアウトプット取得）
