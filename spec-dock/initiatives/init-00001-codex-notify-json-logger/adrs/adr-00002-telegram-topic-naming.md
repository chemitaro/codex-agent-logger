...
- 影響範囲（コード/テスト/運用/データ）:
  - `epic-00004` の topic 作成処理（topic name 生成）
...
- Follow-ups（追加の Epic/Issue/ADR）:
  - 結論確定後、この ADR を `accepted` にし、`epic-00004` の requirement/design へ反映する

## 参考（References） (任意)
- 関連仕様（requirement/design/plan/report）:
  - `spec-dock/initiatives/init-00001-codex-notify-json-logger/requirement.md`
  - `spec-dock/initiatives/init-00001-codex-notify-json-logger/plan.md`
