...
- 影響範囲（コード/テスト/運用/データ）:
  - `epic-local-00003` の packaging 実装（`pyproject.toml`）
- 移行/ロールバック:
...
- 関連仕様（requirement/design/plan/report）:
  - `spec-dock/initiatives/init-local-00001-codex-notify-json-logger/epics/epic-local-00003-packaging-and-cli/requirement.md`
